...
app.post('/payment/callback', (req, res) => {
  ...
  const frontendUrl = process.env.FRONTEND_URL || 'https://jrb-gold-56cs.vercel.app';
...
app.get('/', (req, res) => {
  res.json({
    ...
    frontend: process.env.FRONTEND_URL || 'https://jrb-gold-56cs.vercel.app'
  });
});
...
app.listen(PORT, () => {
  ...
  console.log(`🌐 Frontend URL: ${process.env.FRONTEND_URL || 'https://jrb-gold-56cs.vercel.app'}`);
});